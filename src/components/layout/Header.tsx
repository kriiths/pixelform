    ...
    <header className="bg-white border-b border-gray-light sticky top-0 z-50 shadow-sm">
      <div className="max-w-6xl mx-auto px-8 py-5 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <Link href="/cart" className="relative text-gray-700 hover:text-black transition px-2 py-1 rounded">
            ...
            {totalItems > 0 && (
              <span className="absolute -top-2 -right-2 bg-pixel text-white text-xs w-5 h-5 rounded-full flex items-center justify-center">
                {totalItems}
              </span>
            )}
          </Link>
